...
func (a *DefaultApiService) SupiUeUpuPost(ctx context.Context, supi string, upuInfo models.UpuInfo) (models.UpuSecurityInfo, *http.Response, error) {
	...
	case 503:
		...
		return localVarReturnValue, localVarHTTPResponse, apiError
	default:
		return localVarReturnValue, localVarHTTPResponse, openapi.ReportError("%d is not a valid status code in SupiUeUpuPost", localVarHTTPResponse.StatusCode)
	}
}
