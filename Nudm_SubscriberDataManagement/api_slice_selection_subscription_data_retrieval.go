...
/*
SliceSelectionSubscriptionDataRetrievalApiService retrieve a UE's subscribed NSSAI
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param supi Identifier of the UE
 * @param optional nil or *GetNssaiParamOpts - Optional Parameters:
...
func (a *SliceSelectionSubscriptionDataRetrievalApiService) GetNssai(ctx context.Context, supi string, localVarOptionals *GetNssaiParamOpts) (models.Nssai, *http.Response, error) {
	var (
		...
		localVarReturnValue  models.Nssai
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/nssai"
