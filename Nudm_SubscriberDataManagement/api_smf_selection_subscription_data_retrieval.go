...
/*
SMFSelectionSubscriptionDataRetrievalApiService retrieve a UE's SMF Selection Subscription Data
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param supi Identifier of the UE
 * @param optional nil or *GetSmfSelectDataParamOpts - Optional Parameters:
...
func (a *SMFSelectionSubscriptionDataRetrievalApiService) GetSmfSelectData(ctx context.Context, supi string, localVarOptionals *GetSmfSelectDataParamOpts) (models.SmfSelectionSubscriptionData, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath() + "/{supi}/smf-select-data"
