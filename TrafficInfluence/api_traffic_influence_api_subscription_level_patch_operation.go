...
type TrafficInfluenceAPISubscriptionLevelPATCHOperationApiService service

/*
TrafficInfluenceAPISubscriptionLevelPATCHOperationApiService Updates/replaces an existing subscription resource
...
func (a *TrafficInfluenceAPISubscriptionLevelPATCHOperationApiService) AfIdSubscriptionsSubscriptionIdPatch(ctx context.Context, afId string, subscriptionId string, trafficInfluSubPatch models.TrafficInfluSubPatch) (models.TrafficInfluSub, *http.Response, error) {
	var (
