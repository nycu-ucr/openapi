...
/*
AccessAndMobilitySubscriptionDataDocumentApiService Retrieves the access and mobility subscription data of a UE
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ueId UE id
 * @param servingPlmnId PLMN ID
 * @param optional nil or *QueryAmDataParamOpts - Optional Parameters:
...
func (a *AccessAndMobilitySubscriptionDataDocumentApiService) QueryAmData(ctx context.Context, ueId string, servingPlmnId string, localVarOptionals *QueryAmDataParamOpts) (models.AccessAndMobilitySubscriptionData, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath() + "/subscription-data/{ueId}/{servingPlmnId}/provisioned-data/am-data"
