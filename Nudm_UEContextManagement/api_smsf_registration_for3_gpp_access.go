...
/*
SMSFRegistrationFor3GPPAccessApiService register as SMSF for 3GPP access
...
func (a *SMSFRegistrationFor3GPPAccessApiService) UpdateSMSFReg3GPP(ctx context.Context, ueId string, smsfRegistration models.SmsfRegistration) (models.SmsfRegistration, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &smsfRegistration
